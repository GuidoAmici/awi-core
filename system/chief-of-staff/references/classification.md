...
5. **Writes** files to appropriate folders under `_documents/organization/`
...
| Type | Path |
|------|------|
| Task | `_documents/organization/tasks/` |
| Project | `_documents/organization/projects/` |
| Product | `_documents/organization/products/` |
| Person | `_documents/organization/people/` |
| Idea | `_documents/organization/ideas/` |
| Output | `_documents/organization/outputs/` |
| Daily | `_documents/organization/daily/` |
| Weekly | `_documents/organization/weekly/` |
| Planning | `_documents/organization/planning/` |
| User observations | `_documents/organization/user-profile-inference/` |
