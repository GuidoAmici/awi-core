...
|---|---|---|
| **Agenda** | `_workspace/<name>/agenda/` | Tasks, projects, daily plans, people, outputs, ideas, planning |
| **Documentation** | `_data/organizations/<name>/documentation/` | Wiki (its own clone), codebase docs, writing style |
...
awi/                            ← AWI engine (this repo)
  ...
  _data/organizations/          ← one cloned repo per company/person
    guido-amici/                ← operator's personal workspace
    ...
    <name>/                     ← company/client instance (created by /awi-initialize)
      ...
      documentation/
        wiki/                   ← company wiki, its own clone
      codebase/                 ← each codebase, its own clone
