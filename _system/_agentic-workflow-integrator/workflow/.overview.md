...
|---|---|---|
| **Agenda** | `_data/organizations/<name>/agenda/` | Tasks, projects, daily plans, people, outputs, ideas, planning |
...
awi/                            ← AWI engine (this repo)
  ...
  _data/organizations/              ← one cloned repo per company/client
...
Commit at logical task boundaries using [Conventional Commits with scope](../references/commit-format.md) (e.g. `docs(newhaze): …`). There is no auto-commit hook.
