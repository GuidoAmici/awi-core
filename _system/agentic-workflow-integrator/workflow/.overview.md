...
|---|---|---|
| **Agenda** | `_data/entities/<name>/agenda/` | Tasks, projects, daily plans, people, outputs, ideas, planning |
| **Documentation** | `_data/entities/<name>/documentation/` | Wiki submodule, codebase docs, writing style |
...
awi/                            ← AWI engine (this repo)
  ...
  _data/entities/              ← one submodule per company/client
