...
AWI is an **integrator framework**: a repo type that integrates existing frameworks and workflows (BASB, COS, GTD, or any other) and registers the decisions that fall between them.
...
## What makes something an AWI decision

A decision belongs in AWI documentation if:
...
| **AWI** | Integrator | Fills gaps between the above; registers custom decisions |

---

## Creator

AWI is designed and built by the AWI operator for their specific deployment context.
