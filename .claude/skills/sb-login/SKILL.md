---
name: sb-login
description: Load a person's profile for this session. Usage: /sb-login <username>. Greets by name, loads preferences and long-term patterns, primes session context.
allowed-tools: Read, Bash, Glob
model: sonnet
subagent_type: general-purpose
---

# /sb-login - Load User Profile

Usage: `/sb-login <username>`
