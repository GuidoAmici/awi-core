...
## [0.8.0](https://github.com/GuidoAmici/awi-core/compare/v0.7.0...v0.8.0) (2026-09-23)


### Características

* **awi:** barrido de stacks de Supabase sin uso al arrancar la sesión ([160c207](https://github.com/GuidoAmici/awi-core/commit/160c2073b4d7998cb69e98a1e1d7301be8d2156c))
* **awi:** docker-up.sh también prende la integración WSL ([5dc19b1](https://github.com/GuidoAmici/awi-core/commit/5dc19b125a34cd5e469e59d65b0eced40d17ed0b))
* **awi:** levantar Docker Desktop es tarea del agente, no del operador ([56d34ed](https://github.com/GuidoAmici/awi-core/commit/56d34ed77eb416bf590f20e058b1a4edc0c143f8))
...
* **awi:** mismo fix de powershell.exe para el MCP de meta-ads ([c433707](https://github.com/GuidoAmici/awi-core/commit/c43370706406ec96e08a6482aa269898282ba769))
...
* **newhaze:** pinnear mcp==1.3.0 en el bridge de sketchup ([841c50b](https://github.com/GuidoAmici/awi-core/commit/841c50b0b93b38883c1742a458a3aa4cc36c0be8))
* **newhaze:** usar powershell.exe literal en el MCP de sketchup ([6875801](https://github.com/GuidoAmici/awi-core/commit/6875801f34219ea878a24816f7d859317b9b34d9))
...
* **awi:** las reglas de forma salen a un plugin y CLAUDE.md pasa a ser la fuente de verdad ([8c31714](https://github.com/GuidoAmici/awi-core/commit/8c3171446ed1636d99045a5ac90a3070d9517a71))
...
* **awi:** activar superpowers y github, apagar claude-hud ([3afa713](https://github.com/GuidoAmici/awi-core/commit/3afa7130f9425a9ccd4d8bf3a0d1e768e5b0add9))
* **newhaze:** exponer D:/Photoshop-work y D:/Blender-work al MCP de filesystem ([950909f](https://github.com/GuidoAmici/awi-core/commit/950909f2fafffa465da2f645580c2129d1dd3541))
* **newhaze:** registrar blender-3 en 9879 como instancia dedicada del agente ([22e1812](https://github.com/GuidoAmici/awi-core/commit/22e1812d796fe444a4aa71cb5874200683407eb9))
* **newhaze:** registrar MCP de blender para diseño del exhibidor GSG ([bfe450f](https://github.com/GuidoAmici/awi-core/commit/bfe450fd063c5bc5d80684e030ed815d1b62f091))
* **newhaze:** registrar MCP de sketchup para el exhibidor GSG ([0d7712f](https://github.com/GuidoAmici/awi-core/commit/0d7712f932fc22f644e7ea6492835614b62f1456))
...
* **answerable:** el detalle toma la forma de su contenido y el bloque que contesta va primero ([9e5038f](https://github.com/GuidoAmici/awi-core/commit/9e5038fca2a15dcc93225eef252061d359d0e792))
...
* **awi:** cierra el aislamiento por worktree y documenta el camino de la DB ([18462f4](https://github.com/GuidoAmici/awi-core/commit/18462f40fc6d014e6f85018aa0ef6b3fc594921d))
...
* **awi:** el fix de puerto está en PR, no en una rama activa ([0e53b67](https://github.com/GuidoAmici/awi-core/commit/0e53b67cf367d1882ae84d1c25b7aaad62a3b682))
* **awi:** el README describe lo que existe y la tabla de skills lista las 30 ([eabb285](https://github.com/GuidoAmici/awi-core/commit/eabb2857f28ae39ed01e4ad21b7013faf57b2f95))
...
* **awi:** handoffs en carpeta propia con estado y supersedes por sección ([5ef76d5](https://github.com/GuidoAmici/awi-core/commit/5ef76d5967c7f07fe89c149cdeaac0a54472354f))
...
* **newhaze:** summary del issue 255 — home como shell estático desde el CDN ([e3b3fbe](https://github.com/GuidoAmici/awi-core/commit/e3b3fbeb09798e9f144eaba2fa124cc2bda3a2ad))
